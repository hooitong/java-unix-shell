...
/**
 * These are the tests given from other users meant for TDD purposes. It adds on
 * to our own test within CalApplicationTest.
 */
public class CalApplicationExtra {
	private CalApplication calApp;
	private OutputStream outStream;
	private final static int DAYS_OF_MONTH[] = { 31, 28, 31,
			30, /* jan feb mar apr */
	...
	public void testRun() throws CalException {
		...
		try {
			...
			String expected = "    January 2010    " + System.lineSeparator() + "Su Mo Tu We Th Fr Sa"
					+ System.lineSeparator() + "                1  2" + System.lineSeparator() + " 3  4  5  6  7  8  9"
					+ System.lineSeparator() + "10 11 12 13 14 15 16" + System.lineSeparator() + "17 18 19 20 21 22 23"
					+ System.lineSeparator() + "24 25 26 27 28 29 30" + System.lineSeparator() + "31"
	...
	public void testPrintCalWithMondayFirst() {
		...
		GregorianCalendar gregCal = new GregorianCalendar();
		String expected = formatCalendarMonthly(
				getCalendarMonthlyTable(gregCal.get(Calendar.MONTH), gregCal.get(Calendar.YEAR), true));
	...
	public void testPrintCalForMonthYear2() {
		String[] args = { "7", "2010" };
		String result = calApp.printCalForMonthYear(args);
		String expected = "     July 2010      " + System.lineSeparator() + "Su Mo Tu We Th Fr Sa"
				+ System.lineSeparator() + "             1  2  3" + System.lineSeparator() + " 4  5  6  7  8  9 10"
				+ System.lineSeparator() + "11 12 13 14 15 16 17" + System.lineSeparator() + "18 19 20 21 22 23 24"
				+ System.lineSeparator() + "25 26 27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYear3() {
		String[] args = { "12", "2010" };
		String result = calApp.printCalForMonthYear(args);
		String expected = "   December 2010    " + System.lineSeparator() + "Su Mo Tu We Th Fr Sa"
	...
	public void testPrintCalForMonthYear4() {
		String[] args = { "1", "2020" };
		String result = calApp.printCalForMonthYear(args);
		String expected = "    January 2020    " + System.lineSeparator() + "Su Mo Tu We Th Fr Sa"
				+ System.lineSeparator() + "          1  2  3  4" + System.lineSeparator() + " 5  6  7  8  9 10 11"
				+ System.lineSeparator() + "12 13 14 15 16 17 18" + System.lineSeparator() + "19 20 21 22 23 24 25"
				+ System.lineSeparator() + "26 27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYear5() {
		String[] args = { "7", "2020" };
		String result = calApp.printCalForMonthYear(args);
		String expected = "     July 2020      " + System.lineSeparator() + "Su Mo Tu We Th Fr Sa"
				+ System.lineSeparator() + "          1  2  3  4" + System.lineSeparator() + " 5  6  7  8  9 10 11"
				+ System.lineSeparator() + "12 13 14 15 16 17 18" + System.lineSeparator() + "19 20 21 22 23 24 25"
				+ System.lineSeparator() + "26 27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYear6() {
		String[] args = { "12", "2020" };
		String result = calApp.printCalForMonthYear(args);
		String expected = "   December 2020    " + System.lineSeparator() + "Su Mo Tu We Th Fr Sa"
	...
	public void testPrintCalForMonthYearMondayFirst1() {
		...
		String expected = "    January 2010    " + System.lineSeparator() + "Mo Tu We Th Fr Sa Su"
				+ System.lineSeparator() + "             1  2  3" + System.lineSeparator() + " 4  5  6  7  8  9 10"
				+ System.lineSeparator() + "11 12 13 14 15 16 17" + System.lineSeparator() + "18 19 20 21 22 23 24"
				+ System.lineSeparator() + "25 26 27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYearMondayFirst2() {
		...
		String result = calApp.printCalForMonthYearMondayFirst(args);
		String expected = "     July 2010      " + System.lineSeparator() + "Mo Tu We Th Fr Sa Su"
				+ System.lineSeparator() + "          1  2  3  4" + System.lineSeparator() + " 5  6  7  8  9 10 11"
				+ System.lineSeparator() + "12 13 14 15 16 17 18" + System.lineSeparator() + "19 20 21 22 23 24 25"
				+ System.lineSeparator() + "26 27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYearMondayFirst3() {
		...
		String result = calApp.printCalForMonthYearMondayFirst(args);
		String expected = "   December 2010    " + System.lineSeparator() + "Mo Tu We Th Fr Sa Su"
				+ System.lineSeparator() + "       1  2  3  4  5" + System.lineSeparator() + " 6  7  8  9 10 11 12"
				+ System.lineSeparator() + "13 14 15 16 17 18 19" + System.lineSeparator() + "20 21 22 23 24 25 26"
				+ System.lineSeparator() + "27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYearMondayFirst4() {
		...
		String result = calApp.printCalForMonthYearMondayFirst(args);
		String expected = "    January 2020    " + System.lineSeparator() + "Mo Tu We Th Fr Sa Su"
				+ System.lineSeparator() + "       1  2  3  4  5" + System.lineSeparator() + " 6  7  8  9 10 11 12"
				+ System.lineSeparator() + "13 14 15 16 17 18 19" + System.lineSeparator() + "20 21 22 23 24 25 26"
				+ System.lineSeparator() + "27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYearMondayFirst5() {
		...
		String result = calApp.printCalForMonthYearMondayFirst(args);
		String expected = "     July 2020      " + System.lineSeparator() + "Mo Tu We Th Fr Sa Su"
				+ System.lineSeparator() + "       1  2  3  4  5" + System.lineSeparator() + " 6  7  8  9 10 11 12"
				+ System.lineSeparator() + "13 14 15 16 17 18 19" + System.lineSeparator() + "20 21 22 23 24 25 26"
				+ System.lineSeparator() + "27 28 29 30 31" + System.lineSeparator();
	...
	public void testPrintCalForMonthYearMondayFirst6() {
		...
		String result = calApp.printCalForMonthYearMondayFirst(args);
		String expected = "   December 2020    " + System.lineSeparator() + "Mo Tu We Th Fr Sa Su"
				+ System.lineSeparator() + "    1  2  3  4  5  6" + System.lineSeparator() + " 7  8  9 10 11 12 13"
				+ System.lineSeparator() + "14 15 16 17 18 19 20" + System.lineSeparator() + "21 22 23 24 25 26 27"
				+ System.lineSeparator() + "28 29 30 31" + System.lineSeparator();
	...
	private ArrayList<ArrayList<String>> getCalendarMonthlyTable(int currentMonth, int currentYear,
			boolean startsWithMonday) {
		...
		int leadGap = startsWithMonday ? calendar.get(Calendar.DAY_OF_WEEK) - 2
