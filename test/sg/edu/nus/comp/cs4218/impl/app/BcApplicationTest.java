...
public class BcApplicationTest {
    ...
    private final String DEFAULT_ERROR = "0";
    private final int RANDOM_LENGTH = 10000;
    ...
    public void testNaturalNumber() throws Exception {
        ...
        assert(mockNumberRight.equals(result));
    }
    ...
    public void testFloatNumber() throws Exception {
        ...
        assert(mockNumberLeft.equals(result));
    }
    ...
    public void testInvalidNumber () throws Exception {
        ...
        assert(DEFAULT_ERROR.equals(result));
    }
    ...
    public void testNegate() throws Exception {
        ...
        assert((unaryOpr + mockNumberLeft).equals(result));
    }
    ...
    public void testPow() throws Exception {
        String binOpr = "^";
        String expectedResult = Double.toString(Math.pow(Float.parseFloat(mockNumberLeft), Integer.parseInt(mockNumberRight)));
    ...
    public void testGreaterThan() throws Exception {
        String binOpr = ">";
        String expectedResult = Float.parseFloat(mockNumberLeft) > Integer.parseInt(mockNumberRight)
                ? "1" : "0";
    ...
    public void testAnd() throws Exception {
        String binOpr = "&&";
        String expectedResult = (Float.parseFloat(mockNumberLeft) != 0) &&
                (Integer.parseInt(mockNumberRight) != 0) ? "1" : "0";
